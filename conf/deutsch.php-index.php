...
$t['login3']=		"Gäste können sich einloggen, in dem ".
			"sie einfach auf <B>Login</B> klicken ".
			"ohne einen Namen einzugeben";
...
$t['neu23']=		"<P>Bitte beachten Sie, daß Ihr <B>Name</B> und Ihre <B>E-Mail</B>\n".
			...
			"Personen nicht zugänglich gemacht wird (gem. <a href=\"http://".$HTTP_HOST."/hilfe.php?http_host=".$HTTP_HOST."&id=&aktion=privacy\">Privacy Policy</a>). Falls Sie zum Beispiel Ihr Passwort\n".
			...
			"<P>Hier können Sie vorab unsere <a href=\"http://".$HTTP_HOST."/hilfe.php?http_host=".$HTTP_HOST."&id=&aktion=agb\">AGBs</a> lesen. Diese müssen vor dem ersten Login bestätigt und akzeptiert werden.</P>\n";
...
$t['neu45']=		"<P>Anmerkung: Sie erhalten nicht sofort einen E-Mail. Ihre Anmeldung muß erst vom Webmaster bestätigt werden.</P>";
...
$t['agb']=	"<p><b>Nutzungsbestimmungen $chat:</b></p>".
		...
		"der Datenspeicherung gemäß unserer <a href=\"http://".$HTTP_HOST."/hilfe.php?http_host=".$HTTP_HOST."&id=&aktion=privacy\" style=\" color: #000000!important; text-decoration: underline; \">Privacy Policy</a> einverstanden.</li>".
		"</ol>".
