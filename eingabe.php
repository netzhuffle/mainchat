...
<?php 
	...
	if (!$eingabe_light) if (!$beichtstuhl || $admin) echo "[<A HREF=\"$mlnk[1]\" TARGET=\"640_$fenster\" onMouseOver=\"return(true)\" onClick=\"neuesFenster2('$mlnk[1]');return(false)\">$t[menue1]</A>]&nbsp;".
					"[<A HREF=\"$mlnk[2]\" TARGET=\"$fenster\" onMouseOver=\"return(true)\" onClick=\"neuesFenster('$mlnk[2]');return(false)\">$t[menue2]</A>]&nbsp;";
	if (!$eingabe_light) if ($communityfeatures && (!$beichtstuhl || $admin)) echo "[<A HREF=\"$mlnk[10]\" TARGET=\"640_$fenster\" onMouseOver=\"return(true)\" onClick=\"neuesFenster2('$mlnk[10]');return(false)\">$t[menue10]</A>]&nbsp;";
	if (!$eingabe_light) if ($forumfeatures && $communityfeatures && (!$beichtstuhl || $admin) && ((isset($aktraum) && $aktraum->r_status1<>"L") || $admin)) echo "[<A HREF=\"$mlnk[11]\" onMouseOver=\"return(true)\" TARGET=\"topframe\">$t[menue11]</A>]&nbsp;";
	...
	if (!$eingabe_light) if (!$beichtstuhl || $admin) echo "[<A HREF=\"$mlnk[3]\" TARGET=\"$fenster\" onMouseOver=\"return(true)\" onClick=\"neuesFenster('$mlnk[3]');return(false)\">$t[menue3]</A>]&nbsp;";
	...
	if ((!$eingabe_light) && (!$eingabe_light_farbe) && (!$admin)) {
