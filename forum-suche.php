...
function such_ergebnis()
{
    ...
    if (strlen($fehler) > 0) {
        ...
        } elseif ($suche['ort'] == "B" && $querybetreff <> "") {
            $abfrage = " " . $querybetreff . " ";
        } elseif ($suche['ort'] == "T" && $querytext <> "") {
            $abfrage = " " . $querytext . " ";
        }
        ...
        while ($thema = mysql_fetch_array($query2, MYSQL_ASSOC)) {
            if (pruefe_leserechte($thema['th_id'])) {
                ...
                } elseif (preg_match("/^B([0-9])+T([0-9])+$/i",
                    $suche['thema'])) {
                ...
                } elseif (preg_match("/^B([0-9])+$/i", $suche['thema'])) {
